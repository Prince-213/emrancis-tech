  ...
  return (
    <div className=" w-[90%] mx-auto ">
      ...
      <div className=" w-[90%] mt-[15vh] pl-6 mx-auto">
        <div className=" flex flex-col space-y-2 max-w-fit">
          <h1 className=" font-medium text-4xl">Log into your Dashboard</h1>
          <svg
        ...
        <form action={logIn} className=" mt-10 space-y-6 w-[90%] ">
