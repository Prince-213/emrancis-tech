  ...
  return (
    <html lang="en">
      <body className={` ${space.className}`}>
        <Suspense fallback={ <div className=" w-full h-screen flex items-center justify-center"> <ScrollDown /> </div> }>
              ...
              <div className=" w-[85%] space-y-24 text-white mx-auto">
                ...
                <div className=" grid grid-cols-1 space-y-10 lg:space-y-0 lg:grid-cols-4 lg:gap-x-32">
                  ...
                  <div className=" space-y-6">
                    ...
                    <p>
                      Subscribe to our newsletter to get our news delivered to
                      you.
                    </p>
                    <div className=" h-12 overflow-hidden w-full flex justify-between rounded-lg border-2 border-[#8080807c] ">
                      ...
                      />
                      <button className=" bg-blue-500 w-[20%] text-center">
                        Join
                      </button>
                    </div>
                  </div>
